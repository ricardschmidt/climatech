            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">Climatech
                                    <span>conforto ambiental</span>
                                </h1>
                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">Missão</h6>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-success text-uppercase">Visão</h6>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-warning text-uppercase">Valores</h6>
                                    <p class="description mt-3">Argon is a great free UI package based on Bootstrap
                                        4 that includes the most important components and features.</p>
                                    <div>
                            ...
                            <ul class="list-unstyled mt-5">
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-basket"></badge>
                                ...
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h6 class="mb-0">Instalação</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-satisfied"></badge>
                                        <h6 class="mb-0">Higienização</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-paper-diploma"></badge>
                                        <h6 class="mb-0">PMOC</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-hat-3"></badge>
                                        <h6 class="mb-0">Laudo Técnico</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-like-2"></badge>
                                        <h6 class="mb-0">Manutenção Corretiva</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-support-16"></badge>
                ...
                <div class="row row-grid align-items-center">
                    <div class="col-md-6">
                        <div class="card bg-default shadow border-0">
                            <img v-lazy="'https://ras-upload.s3.amazonaws.com/sites/climatech/img/theme/img-1-1200x1000.jpg'" class="card-img-top">
        ...
        <section class="section section-lg">
            <div class="container">
                <div class="row justify-content-center text-center mb-lg">
                    <div class="col-lg-8">
                        <h2 class="display-3">Nosso incrível time</h2>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 mb-5 mb-lg-0">
                        <div class="px-4">
                            ...
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Paulo Roberto Ribas</span>
                                    <small class="h6 text-muted">Engenheiro Mecânico</small>
                                </h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 mb-5 mb-lg-0">
                        <div class="px-4">
                            ...
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Noemi Machado de Paula Ribas</span>
                                    <small class="h6 text-muted">Estrategista de Marketing</small>
                                </h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-3 ml-lg-auto">
                                <base-button tag="a" href="https://api.whatsapp.com/send/?phone=5541984056286&text=Ol%C3%A1%20gostaria%20de%20fazer%20um%20or%C3%A7amento&app_absent=0"
            ...
            <div class="container">
                <div class="row row-grid justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="display-3">Você gostou de
                        ...
                        <div class="btn-wrapper">
                            <a href="https://api.whatsapp.com/send/?phone=5541984056286&text=Ol%C3%A1%20gostaria%20de%20fazer%20um%20or%C3%A7amento&app_absent=0"
                               class="btn btn-primary mb-3 mb-sm-0">Entre em Contato</a>
                        </div>
                    </div>
                </div>
            </div>
